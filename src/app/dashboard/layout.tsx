...
const adminNavItems = [
  ...
  { label: 'Scenarios', href: '/dashboard/scenarios', icon: 'compare_arrows' },
  { label: 'Reports', href: '/dashboard/reports', icon: 'assessment' },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#060e20] grid-pattern relative">
      ...
      {/* Main */}
      <main className="md:ml-64 mt-16 p-4 md:p-8 min-h-screen pb-20 md:pb-8 relative z-10">
        {children}
      </main>
    </div>
  );
