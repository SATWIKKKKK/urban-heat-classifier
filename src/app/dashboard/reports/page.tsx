    ...
    <div className="flex flex-col gap-6 max-w-5xl mx-auto">
      ...
      <div>
        ...
        <div className="flex items-end justify-between gap-4">
          ...
          <span className="shrink-0 text-xs text-[var(--text-tertiary)] bg-[var(--bg-surface)] border border-[var(--border)] rounded-lg px-3 py-1.5">
        ...
        <div className="flex flex-col gap-3">
          {reports.map((report) => {
            ...
            return (
              <div
                key={report.id}
                className="group relative flex flex-col sm:flex-row sm:items-center gap-3 p-5 bg-[var(--bg-surface)] border border-[var(--border)] rounded-2xl hover:border-[rgba(34,197,94,0.35)] transition-all"
              >
                {/* Left: icon */}
                ...
                <Link
                  ...
                  className="shrink-0 flex items-center gap-1.5 px-4 py-2 text-[12px] font-semibold text-[#22c55e] border border-[rgba(34,197,94,0.30)] rounded-lg hover:bg-[rgba(34,197,94,0.08)] transition-colors whitespace-nowrap"
                >
                  View Report
